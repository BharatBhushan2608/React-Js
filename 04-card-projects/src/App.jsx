...
const App = () => {
  ...
  return (
    <div className='parent'>
        ...
        {/* <User name={arr[0]} age="21" />
        <User name={arr[1]} age="21" />
        <User name={arr[2]}age="22" /> */}
        ...
        {jobOpenings.map(function(elem ,idx){
          ...
          return  <div key={idx}> 
            <Card company={elem.companyName } post={elem.post} datepost={elem.datePosted} tag1={elem.tag1} tag2={elem.tag2}
          payment={elem.pay} locality={elem.location} />
          </div>
